...
import { Department, Category } froimport { CreditCard as Edit, Trash2, PlusCircle } from 'lucide-react''lucide-react';
                          ...
                          {department.categories.map((category) => (
                            <tr key={category.id}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <Link to={`/seller/categories/categories/${category.id}/edit`} className="text-brown-600 hover:text-brown-900 mr-3">
                      ...
                      {department.categories.map((category) => (
                        <div key={category.id} className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
                          <div className="flex items-start justify-between mb-2">
                            <h4 className="text-lg font-semibold text-brown-900 flex-1 min-w-0 break-words pr-2">{category.name}</h4>
                            <span className="text-sm text-gray-500 flex-shrink-0">{category.slug}</span>
                          </div>
                          ...
                          <div className="flex justify-end space-x-2">
                            <Link to={`/seller/categories/categories/${category.id}/edit`}>
